...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/Alone95/nav', 

  // 路由是否Hash模式, 如果是部署在github pages 务必设为 true
  hashMode: true,

  // 您的网站地址，这对于SEO很重要
  homeUrl: 'https://nav.alone95.cn',
  ...
  // 网站关键字
  keywords: '导航,前后端资源,社区站点,设计师,实用工具,学习资源,运营,网络安全,node.js',
  ...
  baiduStatisticsUrl: 'https://hm.baidu.com/hm.js?f8dbdd676600bbdceff07abf635322f9',
